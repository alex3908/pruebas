...
Rails.application.configure do
  ...
  if ENV["AZURE_ACCOUNT_NAME"].present? && ENV["AZURE_ACCESS_KEY"].present? && ENV["AZURE_CONTAINER"].present?
  ...
  # config.active_job.queue_name_prefix = "adara_crm_#{Rails.env}"
  ...
  config.action_mailer.asset_host = "http://#{ENV["APP_URL"]}"
